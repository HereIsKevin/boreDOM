    ...
    render(
      ...
      <div id="todo-items">
        ${Array.from(this.items.entries(), (x) => {
          ...
          return `<div class="todo-item" data-index="${index}">
            <label ${checked ? 'style="text-decoration: line-through;"' : ""} class="todo-item-label">
              <input type="checkbox" class="todo-item-checkbox" ${checked ? "checked" : ""}>
              ${content}
            </label>
